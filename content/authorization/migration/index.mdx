...
- Tilby nye og moderne API som gjør det enklere å integrere mot og ta i bruk Altinn Autorisasjon som tilgangsstyringsløsning for andre offentlige tjenester
...
![Skisseforslag på ny brukerflate for tilgangsstyring](https://docs.altinn.studio/nb/authorization/migration/ny-brukerflate-virksomheter.jpg "Forslag til ny brukerflate")
