...
Har ansvar for å berike beslutningsforespørselen slik at autorisasjon kan evalueres korrekt.
...
![Arkitektur](https://docs.altinn.studio/nb/authorization/reference/architecture/authorizationbff.drawio.svg "Konstruksjonsdiagram Altinn Autorisasjon")
